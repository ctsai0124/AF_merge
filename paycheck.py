...
# ── 人員種類（大分類）────────────────────────────────────
# 使用者於 2026/9/10 確認不必再選校長、教師、工友等細職稱；固定清冊可
# 直接填一般人員、職工、約聘雇人員或政務人員。既有 person_categories.json
# 可能已存過舊細分類，rollup_category() 仍會相容讀取並自動歸類。
OFFICIAL_CATEGORIES = ['一般人員', '職工', '約聘雇人員', '政務人員']
...
def category_from_salary_table(code):
    """依 AF「薪俸表別」代碼推導人員種類；辨識不出時回傳 None。
    這是舊格式清冊（沒有人工指定人員類別）的向下相容備援邏輯。"""
    c = (code or '').strip().upper()
    return SALARY_TABLE_CATEGORY.get(c)


# 保留原常數名稱，避免舊程式或既有 API 失效；介面只提供大分類。
FINE_CATEGORY_OPTIONS = list(OFFICIAL_CATEGORIES)

FINE_TO_OFFICIAL = {
    '一般人員': '一般人員', '教育警察人員': '一般人員',
    '政務人員': '政務人員',
    '校長': '一般人員', '主任': '一般人員', '組長': '一般人員',
    '教師': '一般人員', '導師': '一般人員', '科任': '一般人員', '教練': '一般人員',
    '幹事': '一般人員', '書記': '一般人員', '護理師': '一般人員', '校護': '一般人員', '管理員': '一般人員',
    '職工': '職工', '工友': '職工', '技工': '職工', '駕駛': '職工',
    '約聘雇人員': '約聘雇人員', '約聘僱人員': '約聘雇人員',
    '聘用人員': '約聘雇人員', '約僱': '約聘雇人員', '約聘': '約聘雇人員',
}


def rollup_category(fine_category):
    """目前大分類或歷史細分類 → 大類人員種類；辨識不出時回傳 None。"""
