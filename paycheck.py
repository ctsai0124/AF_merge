...
# ── 人員類別（細分類 → 官方五類）─────────────────────────
# 官方五類依據 static/稽核表-.docx「六、各類表別」所列的本俸（薪、餉）
# 表別代碼歸納而來（2026/9 新增）：
#   A0001   公教人員俸表                    → 職員
#   A00011  公教人員俸表(教育警察人員)       → 教育人員
#   A0003   技工工友工餉表                  → 技工工友
#   A0004   聘用人員薪點表                  → 聘用人員
#   A0005   約僱人員薪點表                  → 約僱人員
# 這是目前唯一能在既有文件中找到的「五類」依據；如果 Leo 實際要對的
# 官方報表用的是不同的五類名稱，之後只要改這幾個常數即可，不影響其他邏輯。
OFFICIAL_CATEGORIES = ['教育人員', '職員', '技工工友', '聘用人員', '約僱人員']
...
FINE_TO_OFFICIAL = {
    '校長': '教育人員', '主任': '教育人員', '組長': '教育人員',
    '教師': '教育人員', '導師': '教育人員', '科任': '教育人員', '教練': '教育人員',
    '幹事': '職員', '書記': '職員', '護理師': '職員', '校護': '職員', '管理員': '職員',
    '工友': '技工工友', '技工': '技工工友', '駕駛': '技工工友',
    '聘用人員': '聘用人員',
    '約僱': '約僱人員', '約聘': '約僱人員',
}
