...
def print_audit():
    ...
    audit_html = _build_audit_html(school_name, sn2, yearmonth, data)
    return f'''<!DOCTYPE html>
<html lang="zh-TW"><head><meta charset="UTF-8"><title>稽核表－{school_name}</title>
<style>
  body{{font-family:'Microsoft JhengHei',Arial,sans-serif;margin:20px;font-size:13px}}
